...
class FavoriteMangaAdapter : RecyclerView.Adapter<FavoriteMangaAdapter.MangaViewHolder>() {
    ...
    class MangaViewHolder(private val binding: ItemsFavoriteBinding) : RecyclerView.ViewHolder(binding.root) {
